...
const enTranslations = {
  ...
  "paymentModal": {
    ...
    "product": "You are purchasing: {productName}",
    "payNow": "Pay Now (Coming Soon)",
    "cod": "Cash on Delivery",
    "placeOrder": "Place Order",
    "orderSuccessTitle": "Order Placed!",
    "orderSuccessMessage": "Your order for '{productName}' has been placed successfully. Please pay on delivery.",
    "close": "Close"
  }
};
const hiTranslations = {
  ...
  "paymentModal": {
    ...
    "product": "आप खरीद रहे हैं: {productName}",
    "payNow": "अभी भुगतान करें (जल्द ही आ रहा है)",
    "cod": "कैश ऑन डिलीवरी",
    "placeOrder": "ऑर्डर दें",
    "orderSuccessTitle": "ऑर्डर दिया गया!",
    "orderSuccessMessage": "आपका '{productName}' का ऑर्डर सफलतापूर्वक दे दिया गया है। कृपया डिलीवरी पर भुगतान करें।",
    "close": "बंद करें"
  }
};
const teTranslations = {
  ...
  "paymentModal": {
    ...
    "product": "మీరు కొనుగోలు చేస్తున్నారు: {productName}",
    "payNow": "ఇప్పుడే చెల్లించండి (త్వరలో వస్తుంది)",
    "cod": "క్యాష్ ఆన్ డెలివరీ",
    "placeOrder": "ఆర్డర్ చేయండి",
    "orderSuccessTitle": "ఆర్డర్ ఇవ్వబడింది!",
    "orderSuccessMessage": "'{productName}' కోసం మీ ఆర్డర్ విజయవంతంగా ఇవ్వబడింది. దయచేసి డెలివరీపై చెల్లించండి.",
    "close": "మూసివేయండి"
  }
};
...
const mlTranslations = {
  ...
  "paymentModal": {
    ...
    "product": "നിങ്ങൾ വാങ്ങുന്നത്: {productName}",
    "payNow": "ഇപ്പോൾ പണമടയ്ക്കുക (ഉടൻ വരുന്നു)",
    "cod": "ക്യാഷ് ഓൺ ഡെലിവറി",
    "placeOrder": "ഓർഡർ നൽകുക",
    "orderSuccessTitle": "ഓർഡർ നൽകി!",
    "orderSuccessMessage": "'{productName}' എന്നതിനുള്ള നിങ്ങളുടെ ഓർഡർ വിജയകരമായി നൽകി. ദയവായി ഡെലിവറിയിൽ പണമടയ്ക്കുക.",
    "close": "അടയ്ക്കുക"
  }
};
