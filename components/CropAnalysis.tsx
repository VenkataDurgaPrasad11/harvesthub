...
import { AppView, CropHealthHistoryItem } from '../types';
...
const CropAnalysis: React.FC<CropAnalysisProps> = ({ setCurrentView }) => {
  ...
  const saveToHistory = (analysisResult: any) => {
    ...
    const newHistoryItem: CropHealthHistoryItem = {
      id: new Date().toISOString(),
      imageUrl: previewUrl,
      analysis: {
        disease: analysisResult.disease || 'Unknown',
        remedy: analysisResult.remedy || 'No remedy provided.',
      },
      timestamp: new Date().toISOString(),
    };
    
    api.saveCropHealthHistory(newHistoryItem);
  };
